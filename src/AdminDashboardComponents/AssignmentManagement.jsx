...
const AssignmentManagement = () => {
    ...
    const fetchSubmissions = async (assignmentId) => {
        const response = await fetch(`${process.env.BACKEND_URL}/api/assignments/${assignmentId}`, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = modalMode === 'add'
                ? '${process.env.BACKEND_URL}/api/assignments'
                : `${process.env.BACKEND_URL}/api/assignments/${selectedAssignment._id}`;
    ...
    const handleGradeSubmission = async (assignmentId, submissionId, grade, feedback) => {
        try {
            const response = await fetch(
                `${process.env.BACKEND_URL}/api/assignments/${assignmentId}/submissions/${submissionId}`,
                {
                    method: 'PATCH',
                    headers: {
