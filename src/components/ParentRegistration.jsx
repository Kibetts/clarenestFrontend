...
const ParentRegistration = () => {
    ...
    //         const response = await fetch(`${process.env.REACT_APP_API_URL || '${process.env.BACKEND_URL}'}/api/parents/register/${studentId}`, {
    //             method: 'POST',
    //             headers: {
    ...
    //         const loginResponse = await fetch(`${process.env.REACT_APP_API_URL || '${process.env.BACKEND_URL}'}/api/auth/login`, {
    //             method: 'POST',
    //             headers: {
    //                 'Content-Type': 'application/json'
    //             },
